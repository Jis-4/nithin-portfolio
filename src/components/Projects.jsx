...
export const project = [
  {
    title: "Co People",
    description:
      "Co People is a dynamic web application I crafted using Node JS and React. This project is a modern and engaging social platform that allows users to connect, share content and interact seamlessly.",
    image: { vpn },
